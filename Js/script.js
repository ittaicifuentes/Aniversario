...
/* fetch('Img/tree-love.svg')
var CadImg = "https://www.svgrepo.com/show/237760/tree-love.svg";
	fetch(CadImg.substring(-13))*/
  fetch('Img/tree-love.svg')
  .then(res => res.text())
  .then(svgText => {
...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Para mi PiaPia:\n\nYa son 8 años los que llevamos juntos. Cada momento que vivimos juntos… me hace sentir en casa.\n\nGracias por tanto respeto, paciencia, apoyo y por sobre todo, llenar mis días de amor.\n\nTe amo con todo mi corazón.`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con amor, IttaiSin";
...
function showCountdown() {
  ...
  function update() {
    ...
    container.innerHTML =
      `Llevamos juntos: <b>${days}</b> días<br>Faltan: <b>${eventDays}d ${eventHours}h ${eventMinutes}m ${eventSeconds}s</b> para<br>nuestro aniversario`;
